...
def cs_service_bot():
    ...
    if response == "1":
        ...
        print("Sorry, we didn't understant your selection.")
...
def existing_customer():
    print("What kind of support you need? \n [1] Television Support \n [2] Internet Support \n [3] speak to a support representative")
...
def new_customer():
    ...
    response3 = input("Please enter the number corresponding to your choice ")
    if response3 == "1":
        return sign_up()
    elif response3 == "2":
        return home_visit()
...
def television_support():
    ...
    response4 = input("Please enter the number corresponding to your choice ")
    if response4 == "1":
        print("Please check the channel lists at DefinitelyNotSinister.com. If the channel you cannot access is there, please contact live representative.")
        return did_that_help()
    elif response4 == "2":
        print("Try adjusting your antenna above your television set")
        return did_that_help()
    elif response4 == "3":
...
def internet_support():
    print("What is the nature of your problem? \n [1] I can't connect to the internet \n [2] My pconnection is very slow \n [3] I can't access certain sites \n [4] Other issues")

    response5 = input("Please enter the number corresponding to your choice ")   
    if response5 == "1":
        ...
        print("Move to a different region or instal a VPN. Some areas block certain sites")
        return did_that_help()
    elif response5 == "4":
        return live_rep("support")
...
def did_that_help():
    ...
    response6 = input("Please input yes or no ")
    if response6 == "Yes":
        print("Thank you!")
    elif response6 == "No":
        print("Would you rather \n [1] Talk to a live representative \n [2] Shedule a home visit")
        response7 = input("Please enter your preferred choice ")
        if response7 == "1":
            return live_rep("support")
        elif response7 == "2": 
            return home_visit("support")
        else:
            print("Sorry, your selection doesn't make sense. Try again")
            return did_that_help()
    else: 
        print("Sorry, your selection doesn't make sense. Try again")
        return did_that_help()
...
def sign_up():
    print("Great choice, my friend! We're excited to thave you join the DNS family! Please select the package you are interested in signing up for: \n [1] Bundle Deal (Internet + Cable \n [2] Internet \n [3] Cable ")
    
    return8 = input("Please enter the number corresponding to your choice ")
    if response8 == "1":
        print("You've selected the Bundle Package! Please schedule a home visit and our technician will come and set up yournew service.")
        ...
        print("You've selected the Cable Only Package! Please schedule a home visit and our technician will come and set up yournew service.")
        return home_visit("new install")
    else:
        print("Uh-oh, you made a wrong choice. Try to select the correct number again, you dufus")
        return sign_up()
...
def home_visit(purpose):
    ...
    response9 = input("Please enter the purpose of your home visit ")
    if response9 == "1": 
        return home_visit("new install")
    elif response9 == "2":
        return home_visit("support")
    ...
    visit_date = input("Please enter the date of your choice")
        print("Wonderful! A technician will come visit you on [visit_date]. Please be available between the hourse of 1:00 am and 11:00 pm")
        return visit_date
...
def live_rep(purpose):
    if purpose == "sales":
        ...
        print("Please hold while we connect you with a live support representative. The wait tile will be between two minutes and six hours. We thank you for your patience.")
    
print(live_rep("support"))        
